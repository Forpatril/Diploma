...
imnoise_overview.html - HTML overview documentation file for the generated component. It 
                        contains the requirements for accessing the component and for 
                        generating arguments using the MWArray class hierarchy.

imnoise.xml - This file contains the code comments for the imnoise component classes and 
                        ...
                        online documentation for the imnoise component.
