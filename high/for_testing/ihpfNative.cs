...
namespace highNative
{
  ...
  /// <summary>
  /// The ihpf class provides a CLS compliant, Object (native) interface to the MATLAB
  ...
  public class ihpf : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input Objectinterface to the high MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <summary>
    /// Provides a single output, 1-input Objectinterface to the high MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// h = hpfilter('gaussian', pq(1), pq(2), d0);
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the high MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// h = hpfilter('gaussian', pq(1), pq(2), d0);
    ...
    /// <summary>
    /// Provides the standard 1-input Object interface to the high MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// h = hpfilter('gaussian', pq(1), pq(2), d0);
