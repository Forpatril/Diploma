...
namespace psnr2
{
  ...
  /// <summary>
  /// The psnrClass class provides a CLS compliant, MWArray interface to the M-functions
  ...
  public class psnrClass : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the psnr M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the psnr M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// PSNR (Peak Signal to noise ratio)
    ...
    /// <summary>
    /// Provides a single output, 2-input MWArrayinterface to the psnr M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// PSNR (Peak Signal to noise ratio)
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray psnr(MWArray A, MWArray B)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the psnr M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// PSNR (Peak Signal to noise ratio)
    ...
    /// <summary>
    /// Provides the standard 1-input MWArray interface to the psnr M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// PSNR (Peak Signal to noise ratio)
    ...
    /// arguments.</returns>
    ///
    public MWArray[] psnr(int numArgsOut, MWArray A)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input MWArray interface to the psnr M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// PSNR (Peak Signal to noise ratio)
    ...
    /// arguments.</returns>
    ///
    public MWArray[] psnr(int numArgsOut, MWArray A, MWArray B)
    {
