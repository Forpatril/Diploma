...
namespace filterNative
{
  ...
  public class filterclass : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input Objectinterface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    {
      return mcr.EvaluateFunction("filter2", new Object[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input Objectinterface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object filter2(Object image)
    {
    ...
    /// <summary>
    /// Provides a single output, 2-input Objectinterface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="image">Input argument #1</param>
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object filter2(Object image, Object type)
    {
    ...
    /// <summary>
    /// Provides a single output, 3-input Objectinterface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="image">Input argument #1</param>
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object filter2(Object image, Object type, Object param)
    {
    ...
    /// <summary>
    /// Provides a single output, 4-input Objectinterface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="image">Input argument #1</param>
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object filter2(Object image, Object type, Object param, Object print)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public Object[] filter2(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "filter2", new Object[]{});
    }


    /// <summary>
    /// Provides the standard 1-input Object interface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public Object[] filter2(int numArgsOut, Object image)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input Object interface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public Object[] filter2(int numArgsOut, Object image, Object type)
    {
    ...
    /// <summary>
    /// Provides the standard 3-input Object interface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public Object[] filter2(int numArgsOut, Object image, Object type, Object param)
    {
    ...
    /// <summary>
    /// Provides the standard 4-input Object interface to the filter2 M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments</param>
    ///
    [MATLABSignature("filter2", 4, 2, 0)]
    protected void filter2(int numArgsOut, ref Object[] argsOut, Object[] argsIn, params Object[] varArgsIn)
    {
        mcr.EvaluateFunctionForTypeSafeCall("filter2", numArgsOut, ref argsOut, argsIn, varArgsIn);
    }
    /// <summary>
    /// Provides a void output, 0-input Objectinterface to the runDemo M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the runDemo M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// RUNDEMO Illustrates the use of BFILTER2 and CARTOON.
