...
namespace lowNative
{
  ...
  /// <summary>
  /// The ilpf class provides a CLS compliant, Object (native) interface to the
  ...
  public class ilpf : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input Objectinterface to the low M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// F = fft2(J, PQ(1), PQ(2));
    ...
    /// <summary>
    /// Provides a single output, 1-input Objectinterface to the low M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// F = fft2(J, PQ(1), PQ(2));
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the low M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// F = fft2(J, PQ(1), PQ(2));
    ...
    /// <summary>
    /// Provides the standard 1-input Object interface to the low M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// F = fft2(J, PQ(1), PQ(2));
