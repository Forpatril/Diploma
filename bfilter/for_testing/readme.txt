...
bfilter_overview.html - HTML overview documentation file for the generated component. It 
                        contains the requirements for accessing the component and for 
                        generating arguments using the MWArray class hierarchy.

bfilter.xml - This file contains the code comments for the bfilter component classes and 
                        ...
                        online documentation for the bfilter component.
